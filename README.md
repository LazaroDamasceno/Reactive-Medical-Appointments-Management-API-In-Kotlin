# Reactive-Medical-Appointments-Management-API-In-Kotlin
...
1. Open your CMD.
2. then type ``git clone https://github.com/LazaroDamasceno/Reactive-Medical-Appointments-Management-API-In-Kotlin.git``.
